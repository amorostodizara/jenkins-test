...
<body>
    ...
    <nav class="navbar">
      ...
      <div class="navbar_content">
       ...
       <a href="index.jsp"><img src="images/profile.jpg" alt="" class="profile" /></a>
      </div>
    </nav>
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              <a href="#" class="nav_link sublink">Professeurs</a>
              <a href="#" class="nav_link sublink">Salles</a>
              <a href="#" class="nav_link sublink">Occuper</a>
